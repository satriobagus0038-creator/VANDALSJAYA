...
-- Toko Online Baju Bekas - Vandals Jaya

CREATE DATABASE IF NOT EXISTS vandals_jaya;
USE vandals_jaya;
...
CREATE TABLE IF NOT EXISTS products (
    ...
    description TEXT,
    condition_status ENUM('Seperti Baru', 'Excellent', 'Baik', 'Cukup Baik') DEFAULT 'Baik',
    size VARCHAR(10),
    brand VARCHAR(100),
...
('Kaos & T-Shirt', 'kaos', 'Koleksi kaos dan t-shirt bekas berkualitas'),
('Kemeja', 'kemeja', 'Berbagai jenis kemeja casual dan formal'),
('Jaket & Hoodie', 'jaket', 'Jaket, hoodie, dan outerwear pilihan'),
('Celana', 'celana', 'Celana jeans, chino, cargo, dan lainnya');
